...
use TicketBundle\Form\TicketFolderFormType;
use Symfony\Component\HttpFoundation\Request;
use TicketBundle\TicketFolder\MyClassTest;
...
/*
        $form = $this->get('form.factory')->create(TicketFolderFormType::class, $ticketFolder);
            $message1='';
            $message2 = '';
*/

        $form = $this->createFormBuilder($ticketFolder)
            //->add('lastDateOfVisit', DateType::class)
            ->getForm()
        ;
...
/*
            if ($form->isValid()) {
                ...
                $dateOfVisit = $form['dateOfVisit']->getData();
                ...
                if ($codeDateOk !== 0) {
                    ...
                    return $this->render('TicketBundle:museum:ordertickets.html.twig', [
